...
<div class="form-group {{ $errors->has('point_pour') ? 'has-error' : ''}}">
    <label for="point_pour" class="control-label">{{ 'Point Pour' }}</label>
...
<div class="form-group {{ $errors->has('point_contre') ? 'has-error' : ''}}">
    <label for="point_contre" class="control-label">{{ 'Point Contre' }}</label>
...
<div class="form-group {{ $errors->has('contact_information') ? 'has-error' : ''}}">
    <label for="contact_information" class="control-label">{{ 'Contact Information' }}</label>
