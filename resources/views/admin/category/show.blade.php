            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admincategory' . '/' . $category->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Country Title </th><td> {{ $category->country_title }} </td></tr><th> Country Name </th><td> {{ $category->country_name }} </td></tr><tr><th> Header Text </th><td> {{ $category->header_text }} </td></tr><tr><th> Footer Text </th><td> {{ $category->footer_text }} </td></tr>
                                </tbody>
                            </table>
                        </div>
