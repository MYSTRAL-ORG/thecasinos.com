        ...
        <section class="  feuille ps-2 pe-2">
                        ...
                        <div class=" casino-box  ">
                            <div class="casino-image">
                                ...
                                <div class="category-location">
                                    <img loading="lazy" src="{{ env('APP_URL') }}/img/icons/location.png"
                                         alt="Location">
                            ...
                            <div class="casino-info">
                                ...
                                <a class="button"
                                   href="{{ route('casino', ['country' => $casino->country_title  ,'city' => $casino->city_title , 'name' => $casino->slug] )}}">View
                                    casino</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="pagination-container">
                ...
                <div class="pagination">
                    ...
                    @if($casinos->currentPage() >1)
                        <a class="button" href="{{$casinos->previousPageUrl()}}">Previous</a>
                    @endif
                    @if($casinos->currentPage() < $casinos->lastPage())
                        <a class="button" href="{{$casinos->nextPageUrl()}}">Next</a>
                    @endif
                </div>
            </div>
