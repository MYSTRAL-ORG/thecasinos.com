      ...
      <div className="cgr-game-grid">
        ...
        <motion.button {...tileMotion} transition={{ ...tileMotion.transition, delay: .05 }} className="cgr-game-card cgr-game-card-live" data-open-game="blackjack" type="button" onClick={() => onOpen('blackjack')}>
          <div className="cgr-game-art cgr-blackjack-art" aria-hidden="true">
            ...
            <motion.img src="/cards/heart/11.png" alt="" initial={{ rotate: 10, x: 18, y: -2 }} whileHover={{ rotate: 15, x: 27 }} />
        ...
        <motion.button {...tileMotion} transition={{ ...tileMotion.transition, delay: .1 }} className="cgr-game-card cgr-game-card-live cgr-game-card-compact" data-open-game="video-poker" type="button" onClick={() => onOpen('video-poker')}>
          <div className="cgr-soon-cards cgr-poker-preview" aria-hidden="true">
            <img src="/cards/heart/11.png" alt="" /><img src="/cards/heart/12.png" alt="" /><img src="/cards/heart/13.png" alt="" />
          </div>
          <div><span>9 / 6 Jacks or Better</span><h3>Video poker</h3><small>{wallet.gameStats['video-poker'].rounds} hands played</small></div><b>Play now</b>
        </motion.button>
